            ...
            <div class="radius-inf">
                <form action="control/actualizar" method="POST">
                        ...
                        for ($i=0; $i < count($lista); $i++) {
                            ...
                            echo "  <input type='radio' name='idcarga' value='".$lista[$i]->getidcarga()."' >".$maestro->getappat()." ".$maestro->getapmat()." ".$maestro->getnombre()." | ".$grupo->getsemestre().$grupo->getgrupo().$grupo->getturno()."<br>\n";
