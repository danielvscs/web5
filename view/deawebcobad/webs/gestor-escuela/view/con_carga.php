                ...
                <table>
                    <tbody>
                        ...
                        for ($i=0; $i < count($lista); $i++) { 
                            ...
                            echo "  <td>".$maestro->getappat()." ".$maestro->getapmat()." ".$maestro->getnombre()."</td>\n";
                            
                            $materia =$bde->busca($lista[$i]->getidmateria())[0];
                            echo "  <td>".$materia->getmateria()."</td>\n";

                            $grupo =$bdg->busca($lista[$i]->getidgrupo())[0];
                            echo "  <td>".$grupo->getsemestre().$grupo->getgrupo().$grupo->getturno()."</td>\n";
                            echo "</tr>\n";
                        }
                        ?>
                    </tbody>
